...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Apr1624", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<Apr1624Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Apr1624 API v1");
